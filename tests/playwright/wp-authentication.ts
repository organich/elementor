import { APIRequest, APIRequestContext, Browser } from '@playwright/test';
...
export async function fetchNonce( context: APIRequestContext, baseUrl: string, browser: Browser ) {
